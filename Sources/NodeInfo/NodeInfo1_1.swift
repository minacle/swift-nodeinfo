...
public struct NodeInfo1_1<Metadata>: NodeInfo
where Metadata: Codable & Sendable {

    /// The schema version, must be 1.1.
    public let version: NodeInfoVersion = .v1_1
...
extension NodeInfo1_1 {
    ...
    public struct Protocols: Codable, Sendable {
...
extension NodeInfo1_1.Software {
...
extension NodeInfo1_1.Protocols {
...
extension NodeInfo1_1.Services {
