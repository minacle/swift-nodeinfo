...
public struct NodeInfo1<Metadata>: NodeInfo
where Metadata: Codable & Sendable {

    /// The schema version, must be 1.0.
    public let version: NodeInfoVersion = .v1
