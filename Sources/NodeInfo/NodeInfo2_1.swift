...
public struct NodeInfo2_1<Metadata>: NodeInfo
where Metadata: Codable & Sendable {

    /// The schema version, must be 2.1.
    public let version: NodeInfoVersion = .v2_1
...
extension NodeInfo2_1.Services {
